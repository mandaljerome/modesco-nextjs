...
const page = () => {
    return (
        <div className="flex h-screen w-full items-center justify-center bg-main-darkblue px-4 md:px-0">
            <div className="flex w-full max-w-[350px] flex-col items-center gap-12">
                ...
                >
                    <div className="flex w-full flex-col gap-2">
                        ...
                        <input
                            className="rounded-md bg-[#556884] p-3 text-main-lightblue focus:border-none focus:outline-0 focus:outline-main-lightblue active:border-none active:outline-none"
                            type="text"
                            id="username"
                            name="username"
                        />
